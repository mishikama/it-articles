...
> 💡 *Весь код из статьи доступен на GitHub: [ephemeral-envs-fluxcd](https://github.com/mishikama/it-articles/tree/ephemeral-envs/ephemeral-envs-fluxcd)*
...
А вообще, Flux или Argo? Что выберешь ты?
